...
type AuthClient interface {
	...
	Logout(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*Empty, error)
	LogoutAll(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *authClient) Validate(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*ValidateResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *authClient) Logout(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
func (c *authClient) LogoutAll(ctx context.Context, in *TokenRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type AuthServer interface {
	...
	Logout(context.Context, *TokenRequest) (*Empty, error)
	LogoutAll(context.Context, *TokenRequest) (*Empty, error)
...
func (UnimplementedAuthServer) Validate(context.Context, *TokenRequest) (*ValidateResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Validate not implemented")
}
func (UnimplementedAuthServer) Logout(context.Context, *TokenRequest) (*Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Logout not implemented")
}
func (UnimplementedAuthServer) LogoutAll(context.Context, *TokenRequest) (*Empty, error) {
...
func _Auth_LogoutAll_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).LogoutAll(ctx, req.(*TokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}
